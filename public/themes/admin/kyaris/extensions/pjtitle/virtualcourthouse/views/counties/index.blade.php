...
@section('pageTitle')
	@parent
	: {{{ trans('pjtitle/virtualcourthouse::counties/general.title') }}}
@stop
...
<li class="active">{{{ trans('pjtitle/virtualcourthouse::counties/general.title') }}}</li>
@stop
...
<div class="m-b-md">
	<div class="row">
		<div class="col-sm-6">
			<h3 class="m-b-none">{{{ trans('pjtitle/virtualcourthouse::counties/general.title') }}}</h3>
		</div>
		<div class="col-sm-6 m-t-md text-right">
			<a class="btn btn-primary" href="{{ URL::toAdmin('vc/counties/create') }}"><i class="fa fa-plus"></i> {{{ trans('button.create') }}}</a>
		</div>
	</div>
</div>
	...
	<div class="col-md-12">
		<section class="panel panel-default">
			...
			<div class="table-responsive">
				<table class="data-grid table table-striped b-t b-light" data-source="{{ URL::toAdmin('vc/counties/grid') }}" data-grid="main">
					<thead>
						<tr>
							<th class="col-md-1"><input type="checkbox" name="checkAll" id="checkAll"></th>
							<th data-sort="name" class="col-md-5 sortable">{{{ trans('pjtitle/virtualcourthouse::counties/table.name') }}}</th>
							<th data-sort="state" class="col-md-5 sortable">{{{ trans('pjtitle/virtualcourthouse::counties/table.state') }}}</th>
							<th data-sort="created_at" class="col-md-1 sortable">{{{ trans('pjtitle/virtualcourthouse::counties/table.created_at') }}}</th>
...
@include('pjtitle/virtualcourthouse::counties/grid/results')
@include('pjtitle/virtualcourthouse::counties/grid/pagination')
@include('partials/grid/filters')
@include('pjtitle/virtualcourthouse::counties/grid/no-results')
