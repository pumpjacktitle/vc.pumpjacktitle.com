...
<li class="active">{{{ trans('platform/attributes::general.title') }}}</li>
@stop
...
<div class="m-b-md">
	<div class="row">
		<div class="col-sm-6">
			<h3 class="m-b-none">{{{ trans('platform/attributes::general.title') }}}</h3>
		</div>
	...
	<div class="col-md-12">
		<section class="panel panel-default">
			...
			<div class="table-responsive">
				<table class="data-grid table table-striped b-t b-light" data-source="{{ URL::toAdmin('attributes/grid') }}" data-grid="main">
					<thead>
						<tr>
