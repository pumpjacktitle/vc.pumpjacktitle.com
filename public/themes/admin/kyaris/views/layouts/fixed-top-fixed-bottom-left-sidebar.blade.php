    ...
    <section class="vbox">
        <header class="bg-dark dk header navbar navbar-fixed-top-xs">
            <div class="navbar-header aside-md">
                ...
                <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="/themes/admin/kyaris/assets/images/logo.png" class="m-r-sm">@setting('platform.site.title') &nbsp;Admin</a>
                        ...
                        <section class="w-f scrollable">
                            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                                ...
                                <nav class="nav-primary hidden-xs">
                                    {{-- menu widget --}}
                                    @widget('platform/menus::nav.show', array('admin', 0, 'nav', admin_uri(), 'widgets/menus/nav'))
                                </nav>
                                <!-- / nav -->
                            </div>
                        </section>
