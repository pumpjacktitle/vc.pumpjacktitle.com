    ...
    <section class="vbox">
        <header class="bg-dark dk header navbar navbar-fixed-top-xs">
            <div class="navbar-header aside-md">
                ...
                <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="/themes/frontend/kyaris/assets/images/logo.png" class="m-r-sm">@setting('platform.site.title') &nbsp;Admin</a>
