<section class="panel panel-dark no-border" id="section-keyword">
	<header class="panel-heading font-bold">
		<span class="panel-title">
			...
			&nbsp; {{ trans('pjtitle/vc::search/form.keyword_section_title') }}
	...
	<div class="panel-body">
		...
		<div class="form-group m-b-n-xs" id="section-keyword" class="bg-white">
			<label class="col-sm-2 control-label">
				{{ trans('pjtitle/vc::search/form.keyword') }}
			</label>
			<div class="col-sm-10">
				<div class="row">
					<div class="col-sm-10">
						...
						<span class="help-block">{{ trans('pjtitle/vc::search/form.keyword_help') }}</span>
					</div>
				</div>
			</div>
		</div>
