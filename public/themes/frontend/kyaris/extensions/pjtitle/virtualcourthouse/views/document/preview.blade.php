<?php
	$cwlId   = array_get($document, 'id') ?: array_get($document, 'cwlId');
	$documentName = array_get($document, 'name');
	$cwlid        = array_get($document, 'cwlId');
	$searchId     = array_get($document, 'search_id');
?>
<!DOCTYPE html>
<!--
...
<head>
	...
	<link rel="stylesheet" href="/themes/frontend/kyaris/extensions/pjtitle/virtualcourthouse/assets/js/viewer/web/viewer.css"/>

	<script type="text/javascript" src="/themes/frontend/kyaris/extensions/pjtitle/virtualcourthouse/assets/js/viewer/web/compatibility.js"></script>

	<!-- This snippet is used in production, see Makefile -->
	<link rel="resource" type="application/l10n" href="/themes/frontend/kyaris/extensions/pjtitle/virtualcourthouse/assets/js/viewer/web/locale/locale.properties"/>
	<script type="text/javascript" src="/themes/frontend/kyaris/extensions/pjtitle/virtualcourthouse/assets/js/viewer/web/l10n.js"></script>
	<script type="text/javascript" src="/themes/frontend/kyaris/extensions/pjtitle/virtualcourthouse/assets/js/viewer/build/pdf.js"></script>

	<script type="text/javascript" src="/themes/frontend/kyaris/extensions/pjtitle/virtualcourthouse/assets/js/viewer/web/debugger.js"></script>

	<script type="text/javascript">
		var DEFAULT_FILENAME = "{{ $documentName }}"
		var DEFAULT_URL = "{{ URL::to("vc/search/document/{$cwlId}/stream") }}";
		var CWLID = "{{ URL::to("vc/search/document/{$cwlId}/download") }}";
	</script>

	<script type="text/javascript" src="/themes/frontend/kyaris/extensions/pjtitle/virtualcourthouse/assets/js/viewer/web/viewer.js"></script>

	<style type="text/css" media="print">
		#outerContainer {display:none;visibility:hidden;}
...
<body tabindex="1">
	...
	<div class="no-print-message" style="display:none;">
		<h1>You cannot print this document.</h1>
	</div>
				...
				<div id="toolbarContainer">
					<div id="toolbarViewer">
						...
						<div id="toolbarViewerRight">
							...
							<button id="download" class="toolbarButton download hiddenMediumView" title="Download" tabindex="15" data-l10n-id="download" data-cwlid="{{ $cwlid }}">
							  <span data-l10n-id="download_label">Download</span>
							</button>
							<!-- <div class="toolbarButtonSpacer"></div> -->
